...
gg_cv<- cv %>%
  ...
  ggtitle(paste0("QCR-Benchmark correlation vs Benchmark window plots."))
...
\item Achieved correlations are very high. We believe this suggests that our benchmark captures a large part of 
