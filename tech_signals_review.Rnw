...
Uperf<-rowMeans(head(Usig,-1)*tail(Utr,-1))

perf2plot<- function(x){
  plot(cumsum(x),type="l",main=paste(substitute(x)," sharpe:",round(16*mean(x)/sd(x),digits=2)))
}
...
The signal is the sign of rolling 3m returns, so very very simple. Results seems
to agree with the results presented in the document.
...
\Sexpr{ntable(
  df=rbind(
    data.table(stat="Subset",value="g3"),
    data.table(stat="Signal",value=tbl(c("sign","3month","rolling","total returns"),align=a1)),
    data.table(stat="Pairs",value=comma(ncol(g3tr))),
    data.table(stat="Sharpe",value=comma(16*mean(g3perf)/sd(g3perf),digits=2)),
    data.table(stat="Vol",value=comma(16*100*sd(g3perf),digits=3)),
    data.table(stat="Start",value=rownames(g3tr)[1]),
    data.table(stat="End",value=tail(rownames(g3tr),1))
  ),
  align="l",
  alternating=TRUE,
  add_rownames=FALSE
...
\Sexpr{ntable(
  df=rbind(
    data.table(stat="Subset",value="g10"),
    data.table(stat="Signal",value=tbl(c("sign","3month","rolling","total returns"),align=a1)),
    data.table(stat="Pairs",value=comma(ncol(g10tr))),
    data.table(stat="Sharpe",value=comma(16*mean(g10perf)/sd(g10perf),digits=2)),
    data.table(stat="Vol",value=comma(16*100*sd(g10perf),digits=3)),
    data.table(stat="Start",value=rownames(g10tr)[1]),
    data.table(stat="End",value=tail(rownames(g10tr),1))
  ),
  align="l",
  alternating=TRUE,
  add_rownames=FALSE
...
\Sexpr{ntable(
  df=rbind(
    data.table(stat="Subset",value="g10xg3"),
    data.table(stat="Signal",value=tbl(c("sign","3month","rolling","total returns"),align=a1)),
    data.table(stat="Pairs",value=comma(ncol(g10xg3tr))),
    data.table(stat="Sharpe",value=comma(16*mean(g10xg3perf)/sd(g10xg3perf),digits=2)),
    data.table(stat="Vol",value=comma(16*100*sd(g10xg3perf),digits=3)),
    data.table(stat="Start",value=rownames(g10xg3tr)[1]),
    data.table(stat="End",value=tail(rownames(g10xg3tr),1))
  ),
  align="l",
  alternating=TRUE,
  add_rownames=FALSE
...
\Sexpr{ntable(
  df=rbind(
    data.table(stat="Subset",value="U"),
    data.table(stat="Signal",value=tbl(c("sign","3month","rolling","total returns"),align=a1)),
    data.table(stat="Pairs",value=comma(ncol(Utr))),
    data.table(stat="Sharpe",value=comma(16*mean(Uperf)/sd(Uperf),digits=2)),
    data.table(stat="Vol",value=comma(16*100*sd(Uperf),digits=3)),
    data.table(stat="Start",value=rownames(Utr)[1]),
    data.table(stat="End",value=tail(rownames(Utr),1))
  ),
  align="l",
  alternating=TRUE,
  add_rownames=FALSE
