...
\item there are more ``anomalies'' than there are ``risk premia''
\end{itemize}
\end{minipage}
\\
\end{tabular}
...
&
\Sexpr{make_plot(
  plot(img_sig(apply(qcr_stvf[-(1:ss),],2,rescale)-0.5)),
  width="10cm",
  height="10cm",
  envir=environment()
)}
...
&
\Sexpr{make_plot(
  plot(img_sig(qcr_carry_momentum)),
  width="10cm",
  height="10cm",
  envir=environment()
)}
